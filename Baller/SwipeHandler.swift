    ...
    static func swipeLeft() {
        ...
        for _ in 0...ROWS - 1 {
            while rightIndex > leftIndex {
                ...
                while (balls[rightIndex].color == 0) && (rightIndex > leftIndex) { rightIndex -= 1 }
    ...
    static func swipeRight() {
        ...
        for _ in 0...ROWS - 1 {
            while leftIndex < rightIndex {
                ...
                while (balls[leftIndex].color == 0) && (leftIndex < rightIndex) { leftIndex += 1 }
    ...
    static func swipeTop() {
        ...
        for _ in 0...COLUMNS - 1 {
            while bottomIndex > topIndex {
                ...
                while (balls[bottomIndex].color == 0) && (bottomIndex > topIndex) { bottomIndex -= COLUMNS }
    ...
    static func swipeBottom() {
        ...
        for _ in 0...COLUMNS - 1 {
            while topIndex < bottomIndex {
                ...
                while (balls[topIndex].color == 0) && (topIndex < bottomIndex) { topIndex += COLUMNS }
                //if there is only one ball on the very top, or there are none in the column, move on to the next column
